...
<h4 class="py-3 mb-4"><span class="text-muted fw-light"><?= env('app.title')?> /</span> Ocupaciones</h4>

<?=$this->include('partials/alerts');?>

<div id="card-block" class="card">
    <div class="card-header d-flex flex-column">
        <h5 class="mb-0">Nueva ocupación</h5>
    </div>
    <div class="card-body">
        <form id="occupationForm" class="needs-validation" >
            <div class="row">
                <div class="col-md-12">
                    <!-- Title -->
                    <div class="input-group input-group-merge mb-4">
                      <span id="basic-icon-default-fullname2" class="input-group-text">
                        ...
                        <div class="form-floating form-floating-outline">
                            ...
                            <label for="basic-icon-default-fullname">Título</label>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    console.log('Occupations js loaded');
    ...
    $(function(){
        ...
        $("form").on("submit",function(e){
            e.preventDefault();
            blocking();
            let occupationData = $(this).serializeArray();
            ...
            $.ajax({
                ...
                dataType: "JSON",
                data: occupationData,
            }).done(function(occupation){
                if(occupation.id != null){
                    toastAlert('success','Profesión creada','Profesión guardada exitosamente');
        ...
        dt_basic = dt_basic_table.DataTable({
            ...
            columns: [
                ...
                { data: '', render: function (data, type, row){
                        let occupationJson = JSON.stringify(row);
                        return `
                            <a href="javascript:void(0);" onclick='deleteOccupation(${occupationJson})'
        ...
        $('div.head-label').html('<h5 class="card-title mb-0">Relación de ocupaciones</h5>');
    });
    ...
    function deleteOccupation(occupation)
    {
        Swal.fire({
            title: '¿Estás seguro?',
            text: "No serás capaz de recuperar esta profesión",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Sí, borrar profesión!',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    method: 'POST',
                    url: '/occupation/'+occupation.id,
                    data: { '_method': 'DELETE'},
                    dataType: 'JSON'
                }).done(function(response){
                    Swal.fire({
                        icon: 'success',
                        title: '¡Profesión borrada!',
                        customClass: {
