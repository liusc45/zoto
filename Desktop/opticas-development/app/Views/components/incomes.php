...
<?= $this->section('content') ?>
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"><?= env('app.title')?> /</span> Ingresos</h4>
                          ...
                          ></span>
                            <div class="form-floating form-floating-outline">
                                <input
                                        ...
                                        id="concept"
                                        name="concept"
                                        placeholder="Préstamo de compartamos"
                                        aria-label="Préstamo de compartamos"
                                        aria-describedby="basic-icon-default-fullname2" />
                        ...
                        <div class="input-group input-group-merge mb-4">
                            <div class="form-floating form-floating-outline">
                                <select
                                    ...
                                    <option value="999">Seleccionar opción</option>
    ...
    <script>
        ...
        $(function(){
            ...
            $("form").on("submit",function(e){
                e.preventDefault();
                blocking();
                let incomeData = $(this).serializeArray();
                ...
                $.ajax({
                    ...
                    statusCode: {
                        201: function (){
                            $('#primaryAlertText').text('Ingreso guardado exitosamente');
                ...
                dt_basic = dt_basic_table.DataTable({
                    ...
                    columns: [
                        ...
                        { data: '', render: function (data, type, row) {
                                let date = row.created_at.date.split(' ')[0];
                                return `${date}`;
                            }
                        },
                        { data: 'amount' },
                        ...
                        { data: '', render: function (data, type, row){
                                ...
                                return `
                                    <a href="javascript:void(0);" onclick='deleteIncome(${row.id})'
        ...
        function deleteIncome(id)
        {
            Swal.fire({
                title: '¿Estás seguro?',
                text: "No serás capaz de recuperar este ingreso",
                icon: 'warning',
