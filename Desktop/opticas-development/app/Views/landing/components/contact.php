        ...
        <div class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
            <div class="lg:col-span-2 lg:py-12">
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                    Comunicate con nosotros, ¡nos encantaría ayudarte!
                </h2>
                ...
                <div class="mt-8">
                    <a href="#" class="text-2xl font-bold text-orange-600"> 0151 475 4450 </a>

                    <address class="mt-2 not-italic">Domicilio Conocido 99 en Orizaba, Col. Centro CP. 99999</address>
                </div>
            </div>
                ...
                <form action="#" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-4 text-center sm:grid-cols-3">
                        <div>
                            <label
                                for="Option1"
                                class="block w-full cursor-pointer rounded-lg border border-gray-200 p-3 text-gray-600 hover:border-orange-600 has-[:checked]:border-orange-600 has-[:checked]:bg-orange-600 has-[:checked]:text-white"
                                tabindex="0"
                            >
