    ...
    <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-md">
            <strong class="block text-center text-xl font-bold text-gray-900 sm:text-3xl">
                ¿Quieres que te enviemos las últimas noticias?
            </strong>
            ...
            <div class="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
                ...
                <div>
                    ...
                    <ul class="mt-6 space-y-1">
                        ...
                        <li>
                            <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Privacidad </a>
                        </li>

                        <li>
                            <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Legales </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="mt-16 border-t border-gray-100 pt-8">
            <p class="text-center text-xs/relaxed text-gray-500">
                © Opticas Orlando. Todos los derechos reservados.

                <br />

                Desarrollado por
                <a href="https://sistematlan.com" class="text-gray-700 underline transition hover:text-gray-700/75">Sistematlan</a>.
            </p>
        </div>
    </div>
</footer>
