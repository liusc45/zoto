...
<head>
    ...
    <title>Mi Perfil - <?=env('app.title')?></title>
...
<div class="h-full bg-gray-200 p-8">
    <div class="bg-white flex flex-col md:flex-row rounded-lg shadow-lg p-4">
        ...
        <div class="flex-1 flex flex-col items-center lg:items-end justify-end">
            <div class="flex items-center space-x-4 mt-2">
                <a href="/salir" class="flex items-center bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                    <span>Salir</span>
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12h-9.5m7.5 3l3-3-3-3m-5-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2h5a2 2 0 002-2v-1"></path> </g></svg>
                </a>
            </div>
        </div>
    </div>

    <div class="my-4  space-y-4 2xl:space-y-0 2xl:space-x-4">
