...
<div class="font-sans text-gray-900 antialiased">
    <div class="h-100 flex flex-col sm:justify-center items-center pt-6 sm:pt-0 ">
        <div>
            <a href="/">
                <h2 class="font-bold text-3xl">Entrar <span class="bg-primary text-white px-2 rounded-md"><?=env('app.title')?></span></h2>
            </a>
        </div>
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            <form id="login-form" action="/login-action" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <div class="relative">
                        <input id="password" type="password" name="password" placeholder="contraseña" required autocomplete="current-password" class = 'w-full rounded-md py-2.5 px-4 border text-sm outline-primary'>
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    <button class = 'ms-4 inline-flex items-center px-4 py-2 bg-primary border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-sky-950 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150'>
                        Entrar
                    </button>
