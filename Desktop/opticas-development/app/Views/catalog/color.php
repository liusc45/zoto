...
<h4 class="py-3 mb-4"><span class="text-muted fw-light"><?= env('app.title')?> /</span> Colores</h4>
...
<div id="card-block" class="card">
    ...
    <div class="card-body">
        <form id="ColorForm" class="needs-validation" >
            <div class="row">
                <div class="col-md-12">
                    <!-- Title -->
                    <div class="input-group input-group-merge mb-4">
                      <span id="basic-icon-default-fullname2" class="input-group-text">
                        ...
                        <div class="form-floating form-floating-outline">
                            ...
                            <label for="basic-icon-default-fullname">Color</label>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(function(){
        ...
        $("form").on("submit",function(e){
            e.preventDefault();
            blocking();
            let colorData = $(this).serializeArray();
            ...
            $.ajax({
                ...
                if(occupation.id != null){
                    toastAlert('success','Color creado','Color guardado exitosamente');
                    $('#ColorForm')[0].reset();
        ...
        dt_basic = dt_basic_table.DataTable({
            ...
            columns: [
                ...
                { data: '', render: function (data, type, row){
                        let colorJson = JSON.stringify(row);
                        return `
                            <a href="javascript:void(0);" onclick='deleteOccupation(${colorJson})'
        ...
        $('div.head-label').html('<h5 class="card-title mb-0">Relación de colores</h5>');
    });
    ...
    function deleteOccupation(color)
    {
        Swal.fire({
            title: '¿Estás seguro?',
            text: "No serás capaz de recuperar esta color",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Sí, borrar color!',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    toastAlert('success','Color borrado','Sigamos con el buen trabajo');
                    dt_basic.ajax.reload();
                })
            }
        });
