...
<h4 class="py-3 mb-4"><span class="text-muted fw-light"><?= env('app.title')?> /</span> Lineas</h4>

<div id="card-block" class="card">
    <div class="card-header d-flex flex-column">
        <h5 class="mb-0">Nueva linea</h5>
    </div>
    <div class="card-body">
        <form id="LineForm" class="needs-validation" >
            <div class="row">
                <div class="col-md-12">
                    <!-- Title -->
                      ...
                      <span id="basic-icon-default-fullname2" class="input-group-text">
                        ...
                        <div class="form-floating form-floating-outline">
                            <input
                                ...
                                id="line"
                                name="line"
                                placeholder="Lente de contacto"
                                aria-label="Lente de contacto"
                                aria-describedby="basic-icon-default-fullname2" />
                            <label for="basic-icon-default-fullname">Linea</label>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(function(){
        ...
        $("form").on("submit",function(e){
            e.preventDefault();
            blocking();
            let lineData = $(this).serializeArray();
            ...
            $.ajax({
                ...
                if(occupation.id != null){
                    toastAlert('success','Linea creada','Linea guardada exitosamente');
                    $('#LineForm')[0].reset();
        ...
        dt_basic = dt_basic_table.DataTable({
            ...
            columns: [
                ...
                { data: '', render: function (data, type, row){
                        let lineJson = JSON.stringify(row);
                        return `
                            <a href="javascript:void(0);" onclick='deleteOccupation(${lineJson})'
    ...
    function deleteOccupation(line)
    {
        Swal.fire({
            title: '¿Estás seguro?',
            text: "No serás capaz de recuperar esta linea",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Sí, borrar linea!',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    toastAlert('success','Linea borrada','Sigamos con el buen trabajo');
                    dt_basic.ajax.reload();
                })
            }
        });
