...
if (typeof $ !== 'undefined') {
  $(function () {
    ...
    // Open search on 'CTRL+/  CTRL+ \ en latam'
    $(document).on('keydown', function (event) {
      let ctrlKey = event.ctrlKey,
          //CTRL+K
        slashKey = event.which === 75;//   191;
    ...
    if (searchInput.length) {
      ...
      // var searchData = $.ajax({
      //   //url: "/stock",     // assetsPath + 'json/' + searchJson, //? Use your own search api instead
      //   dataType: 'json',
      //   async: false
      // }).responseJSON;
      ...
      //         templates: {
      //           header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Artículos</h6>',
      //           suggestion: function ({ url, icon, name, store, stock }) {
      //             return (
      //               '<a href="' +
      //               url +
      //               '">' +
      ...
      //           suggestion: function ({ name, store, stock }) {
      //             return (
